...
const LanguageSwitcher = ({ activeTab }) => {
  ...
  const content = activeTab === 'welcome' ? (
    ...
    <>
      ...
      <p>La conception de cet site web est inspirée par mon jeu vidéo mystère préféré : Return of the Obra Dinn. J'ai voulu aussi d'avoir l'option pour mettre le site web en deux langues; vous pouvez l'ajuster en cliquant sur « Welcome » ou « Bienvenue » au dessus.</p>
    </>
  );
